      ...
      {files.map((f, i) => (
        ...
        >
          ...
          <button
            ...
            className="absolute right-1 top-1 flex h-5 w-5 items-center justify-center rounded-md bg-neutral-900/70 text-white opacity-0 backdrop-blur transition-opacity hover:bg-neutral-900/90 group-hover/anexo:opacity-100 focus-visible:opacity-100 [@media(pointer:coarse)]:opacity-100"
          >
            <X className="h-3 w-3" />
          </button>
        </div>
