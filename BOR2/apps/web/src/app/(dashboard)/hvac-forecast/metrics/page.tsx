    ...
    <div className="flex h-full flex-col gap-4">
      ...
      <div className="flex flex-1 items-center justify-center rounded-xl border border-dashed border-border">
        <div className="text-center">
          ...
          {/* Os scores medem Fieldwire, Machines, Contract, QB Time e Storage. A
              HVAC só tem QB Time, então não há preparo a pontuar — a tela espera
              a integração existir, em vez de mostrar todo mundo em 0%. */}
