...
import {
  ArrowLeft, Check, X, Loader2, Search, ChevronRight, Building2, Pencil,
} from "lucide-react"
                        ...
                        return (
                          <div key={lot.address_key} className="border-b border-border/20 last:border-b-0">
                            <div className="flex items-center gap-2 px-3 py-1.5">
                              ...
                              <span className="min-w-0 flex-1 truncate text-[12px] font-medium" title={lot.address_key}>{lot.lot}</span>
                              <ChevronRight className="h-3 w-3 shrink-0 text-muted-foreground/30" />
