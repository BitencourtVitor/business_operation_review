      ...
      <div className="flex flex-wrap items-end gap-3">
        ...
        <div className="flex flex-col gap-1">
          ...
          <Select value={situation} onValueChange={v => { if (v) onSituationChange(v) }}>
            <SelectTrigger className="h-8 w-auto gap-1 rounded-lg border border-input bg-transparent px-2.5 shadow-none ring-0 focus-visible:ring-0 dark:bg-input/30 [&>svg:last-child]:!size-3">
