...
func main() {
	...
	//
	// A chave `atlas` é o acesso ao produto; o acesso por obra é cobrado dentro
	// do handler, porque só ele sabe de qual obra cada recurso é filho.
	atlas := api.Group("/atlas", middleware.RequirePermission(db, "atlas", "read"))
