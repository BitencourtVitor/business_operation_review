...
export default function TimesheetMetrics({ filteredData, financialPass }: TimesheetMetricsProps) {
  return (
    <div className="d-flex flex-row align-items-center justify-content-between" style={{ borderBottom: '1px solid var(--color-border-divider)', borderTop: '1px solid var(--color-border-divider)' }}>
      ...
      <div className='d-flex flex-row align-items-center justify-content-center'>
        ...
        {/* Added Value - Oculta se não tiver permissão financeira */}
        {financialPass && (
        ...
        {/* Removed Value - Oculta se não tiver permissão financeira */}
        {financialPass && (
        ...
        {/* Total Value - Oculta se não tiver permissão financeira */}
        {financialPass && (
