...
export default function EmptyMessage({ message, showEdit, onEdit, icon }: EmptyMessageProps) {
  return (
    <div style={{ height: '100%', minHeight: 120, display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', gap: 12 }}>
      ...
      <span style={{ color: 'var(--color-text-secondary)', fontSize: 15, textAlign: 'center' }}>{message}</span>
      {showEdit && (
