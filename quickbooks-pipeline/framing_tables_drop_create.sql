-- Tabelas FRAMING - DROP e CREATE
-- Execute este SQL no painel do Supabase

-- Primeiro DROP todas as tabelas framing_ (se existirem)
DROP TABLE IF EXISTS public.framing_deposit_lines CASCADE;
DROP TABLE IF EXISTS public.framing_deposits CASCADE;
DROP TABLE IF EXISTS public.framing_vendor_credit_lines CASCADE;
DROP TABLE IF EXISTS public.framing_vendor_credits CASCADE;
DROP TABLE IF EXISTS public.framing_purchase_lines CASCADE;
DROP TABLE IF EXISTS public.framing_purchases CASCADE;
DROP TABLE IF EXISTS public.framing_payment_links CASCADE;
DROP TABLE IF EXISTS public.framing_payments CASCADE;
DROP TABLE IF EXISTS public.framing_invoice_links CASCADE;
DROP TABLE IF EXISTS public.framing_invoice_lines CASCADE;
DROP TABLE IF EXISTS public.framing_invoices CASCADE;
DROP TABLE IF EXISTS public.framing_estimate_links CASCADE;
DROP TABLE IF EXISTS public.framing_estimate_lines CASCADE;
DROP TABLE IF EXISTS public.framing_estimates CASCADE;
DROP TABLE IF EXISTS public.framing_bill_payment_links CASCADE;
DROP TABLE IF EXISTS public.framing_bill_payments CASCADE;
DROP TABLE IF EXISTS public.framing_bill_links CASCADE;
DROP TABLE IF EXISTS public.framing_bill_lines CASCADE;
DROP TABLE IF EXISTS public.framing_bills CASCADE;

-- Agora CREATE todas as tabelas
